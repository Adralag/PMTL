            ...
            plants: [
                {
                    ...
                    cost: "$15",
                    size: "Medium (30-40cm tall)",
                    careinstructions: "Wipe leaves monthly for best growth." ,
            ...
            plants: [
                {
                    ...
                    cost: "$20",
                    size: "Medium (30-40cm tall)",
                    careinstructions: "Fertilize once a month during growing season." ,
            ...
            plants: [
                {
                    ...
                    cost: "$10",
                    size: "Small (10-20cm tall)",
                    careinstructions: "Mist leaves occasionally." ,
            ...
            plants: [
                {
                    ...
                    cost: "$14",
                    size: "Small (10-20cm tall)",
                    careinstructions: "Prune dead leaves regularly." ,
        ...
        },
        {
            ...
            plants: [
                ...
                },
                {
                    ...
                    cost: "$15",
                    size: "Medium (30-40cm tall)",
                    careinstructions: "Repot every 2 years." ,
                    sunlight: "Partial shade" ,
                    watering: "Water when soil is dry" ,
                    availability: "Limited Stock"
                },
            ...
            <div className="navbar" style={styleObj}>
                <div className="tag">
                    <div className="luxury">
                        <img src="https://pmtl.ng/assets/pronto-df59e8b7.webp" alt="" />
                        <a href="/" style={{ textDecoration: 'none' }}>
                            <div>
                                <h3 style={{ color: 'white' }}>PMTL</h3>
                                <i style={{ color: 'white' }}>Where Communication is made Easy</i>
                            </div>
                        </a>
                    </div>
                </div>
                            ...
                            <div className="product-list">
                                {section.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        {plant.size && (
                                            <p className="product-size"><strong>Size:</strong> {plant.size}</p>
                                        )}
